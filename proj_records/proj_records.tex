...
\begin{itemize}[leftmargin=0in, label={}]
    \small{\item{
          \textbf{{Languages}} {: Chinese(native), English, Taiwanese}\vspace{2pt} \\
          \textbf{Programming} {: Modern C++(17), Shell script(Linux), Python, Golang } \vspace{2pt} \\
          \textbf{Skill}     {: Linux(server), Docker, Git, Nginx, mongoDB}\vspace{2pt} \\
          \textbf{Document} {: \LaTeX, Markdown}
          }}
\end{itemize}
