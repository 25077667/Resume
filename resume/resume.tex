...
\begin{minipage}[c]{0.4\textwidth}
  ...
  \href{mailto:zxc25077667@protonmail.com}{Email: \underline{zxc25077667@protonmail.com}}\\
  % Be sure to use a professional *personal* email address
  % \href{https://www.linkedin.com/in/charles-rambo/}{\underline{linkedin.com/in/charles-rambo}} \\
  % you should adjust you linked in profile name to be professional and recognizable
  \href{https://github.com/25077667}{GitHub: \underline{github.com/25077667}}
\end{minipage}
...
\CVSubheading
{Bachelor of Computer Science and Engineering}{Sep. 2018 -- May 2022(planned)}
...
\CVItemListStart
\CVItem{Introduce the operating system.}
\CVItem{Help classmate any question about operating system.}
\CVItemListEnd
...
\CVItemListStart
\CVItem{Teaching}
\CVItem{Server maintainer}
\CVItemListEnd

\CVSubheading
{Information Security Engineering Intern}{June 2019 -- August 2019}
...
\CVSubheading
{The Container Security in Healthcare Data Exchange System}{start from February 2021}
{Bachelor's degree graduation project}{}

\CVSubheading
{{NSYSU reCAPTCHA Solver} $|$ \emph{\small{C++}, \small{Python}}}{Spring 2021}
{CNN recognizor with Ernest Chu}{}

\CVSubheading
{{Arduino Remote Airplane} $|$ \emph{\small{JS}, \small{Arduino}}}{Fall 2018}
